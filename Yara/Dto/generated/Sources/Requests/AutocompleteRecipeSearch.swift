...
extension API {
    ...
    */
    public enum AutocompleteRecipeSearch {

        public static let service = APIService<Response>(id: "autocompleteRecipeSearch", tag: "", method: "GET", path: "/recipes/autocomplete", hasBody: false, securityRequirements: [SecurityRequirement(type: "apiKeyScheme", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AutocompleteRecipeSearch.service)
            }
