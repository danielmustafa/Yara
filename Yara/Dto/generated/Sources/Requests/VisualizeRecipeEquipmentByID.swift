...
extension API {
    ...
    */
    public enum VisualizeRecipeEquipmentByID {

        public static let service = APIService<Response>(id: "visualizeRecipeEquipmentByID", tag: "", method: "GET", path: "/recipes/{id}/equipmentWidget", hasBody: false, securityRequirements: [SecurityRequirement(type: "apiKeyScheme", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: VisualizeRecipeEquipmentByID.service)
            }
