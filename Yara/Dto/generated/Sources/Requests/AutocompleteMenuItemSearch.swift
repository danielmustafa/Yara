...
extension API {
    ...
    */
    public enum AutocompleteMenuItemSearch {

        public static let service = APIService<Response>(id: "autocompleteMenuItemSearch", tag: "", method: "GET", path: "/food/menuItems/suggest", hasBody: false, securityRequirements: [SecurityRequirement(type: "apiKeyScheme", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AutocompleteMenuItemSearch.service)
            }
