...
extension API {
    ...
    */
    public enum ImageAnalysisByURL {

        public static let service = APIService<Response>(id: "imageAnalysisByURL", tag: "", method: "GET", path: "/food/images/analyze", hasBody: false, securityRequirements: [SecurityRequirement(type: "apiKeyScheme", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ImageAnalysisByURL.service)
            }
