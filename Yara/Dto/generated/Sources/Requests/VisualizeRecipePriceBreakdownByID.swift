...
extension API {
    ...
    */
    public enum VisualizeRecipePriceBreakdownByID {

        public static let service = APIService<Response>(id: "visualizeRecipePriceBreakdownByID", tag: "", method: "GET", path: "/recipes/{id}/priceBreakdownWidget", hasBody: false, securityRequirements: [SecurityRequirement(type: "apiKeyScheme", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: VisualizeRecipePriceBreakdownByID.service)
            }
