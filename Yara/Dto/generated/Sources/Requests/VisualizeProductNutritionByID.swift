...
extension API {
    ...
    */
    public enum VisualizeProductNutritionByID {

        public static let service = APIService<Response>(id: "visualizeProductNutritionByID", tag: "", method: "GET", path: "/food/products/{id}/nutritionWidget", hasBody: false, securityRequirements: [SecurityRequirement(type: "apiKeyScheme", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: VisualizeProductNutritionByID.service)
            }
