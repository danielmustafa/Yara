...
extension API {
    ...
    */
    public enum GetConversationSuggests {

        public static let service = APIService<Response>(id: "getConversationSuggests", tag: "", method: "GET", path: "/food/converse/suggest", hasBody: false, securityRequirements: [SecurityRequirement(type: "apiKeyScheme", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GetConversationSuggests.service)
            }
