...
extension API {
    ...
    */
    public enum VisualizeMenuItemNutritionByID {

        public static let service = APIService<Response>(id: "visualizeMenuItemNutritionByID", tag: "", method: "GET", path: "/food/menuItems/{id}/nutritionWidget", hasBody: false, securityRequirements: [SecurityRequirement(type: "apiKeyScheme", scopes: [])])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: VisualizeMenuItemNutritionByID.service)
            }
